...
func (psql *problemPostgres) GetProblemsForSubject(ctx context.Context, subjectID, collegeID uuid.UUID) ([]*models.Problem, models.AppError) {
	var problems []*models.Problem
	...
	result := psql.db.Raw(syllabusQuery, subjectID).Scan(&problems)
